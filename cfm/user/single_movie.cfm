                  ...
                  <h2 class="page-heading">#movie_name#</h2>                    
                    <div class="movie__info">
                        ...
                        <div class="col-sm-8 col-md-9">
                            ...
                            <p class="movie__option"><strong>Movie Trailer : </strong><a href="#movie_trailer#" target="_blank">Click Here</a></p> 
                          
                            <div class="movie__btns movie__btns--full">
                                <a href="show_list.cfm" class="btn btn-md btn--warning">book a ticket for this movie</a>
                            </div>                       
                        </div>
                    </div>           
               ...
               <div class="clearfix"></div>          
                ...
                <div class="choose-container">
                    <cfoutput query="showResult">
                         <cfset time_res=application.show.getTimeSlots(#t_id#,local.mid,local.checkdata)>
                        <div class="clearfix"></div>
