...
<cfset ticket_res=application.bookings.getallBookings(id)>
...
<section class="container text-dark">
            <div class="order-container">
                <div class="order pt-3">
                    ...
                    <p class="order__title text-white">Thank you <br><span class="order__descript">purchased tickets</span></p>
                </div>
                    ...
                    <div class="ticket-position bg-white">
                        ...
                        <div class="ticket__inner">
                            ...
                            <div class="ticket-secondary">
                                ...
                                <span class="ticket__item ">Show date: <strong>#dateFormat(booked_on,"full")#</strong></span>
                                <span class="ticket__item ">Show: <strong>#timeFormat(show_time)#</strong></span>
                                <span class="ticket__item">Language: <strong><span class="ticket__hall">#movie_language#-#movie_format#</strong></span></span>
