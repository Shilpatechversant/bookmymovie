<cfinclude  template = "../user_header.cfm"  runOnce = "true"> 
  <!-- Responsive navbar-->
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container px-lg-5">
                <a class="navbar-brand" href="#!">Book Mymovie</a>
        ...
        <!-- Page Content-->
        <div class="row">
            <div id="carouselExampleSlidesOnly" class="col-md-4 carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                    <img class="d-block w-50" src="../../assets/poster/film4.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                  <img class="d-block w-50" src="../../assets/poster/wall1.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                         <img class="d-block w-50" src="../../assets/wallpaper/wall.jpg" alt="Third slide">
                    </div>
                </div>
            </div>
        </div>
